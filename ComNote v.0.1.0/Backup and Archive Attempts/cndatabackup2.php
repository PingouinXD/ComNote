                        ...
                        <?php include 'cndataconnect.php'; 
                            ...
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <button type="button" class="btn btn-success vote-btn" data-id="<?= $row['nt_num'] ?>" data-vote="up"> ▲ <?php echo htmlspecialchars($user['nt_rating_up']); ?></button>
                                    <button type="button" class="btn btn-danger vote-btn" data-id="<?= $row['nt_num'] ?>" data-vote="down"> ▼ <?php echo htmlspecialchars($user['nt_rating_down']); ?></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
