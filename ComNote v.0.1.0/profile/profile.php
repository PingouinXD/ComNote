                    ...
                    <div class="card-body profile">
                        <div class="d-flex flex-row justify-content-between">
                            <div class="d-flex flex-column">
                                <img class="img-fluid rounded-circle border" src="<?php echo $userProfilePic; ?>" width="100px" />
                        ...
                        <p class="card-text pt-4 pb-4 text-justify"><?php echo $bio; ?></p>
                        <div class="col-md-12">
                            <div class="d-flex flex-row justify-content-between">
                            ...
                            while ($row = $result->fetch_assoc()) { ?>
                                <div class="note rounded-4 p-4 border-0">
                                    <div class="d-flex align-items-center mb-0">
                                        <img class="rounded-circle me-2" src="<?php echo $userProfilePic; ?>" style="width: 6%; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        <p class="text-left ps-1 fw-bold mb-0"><?php echo htmlspecialchars($row['nt_name']); ?></p>
                                        <p class="text-left ps-2 mb-0">@<?php echo htmlspecialchars($row['nt_name']); ?></p>
